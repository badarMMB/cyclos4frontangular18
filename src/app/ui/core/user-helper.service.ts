...
export class UserHelperService {
  ...
  setupRegistrationForm(
    ...
    let mobileForm: UntypedFormGroup = null;
    ...
    let landLineForm: UntypedFormGroup = null;
  ...
  ): [UntypedFormGroup, UntypedFormControl, Subscription[]] {
    const addressAvailability = configuration.availability;
    let addressForm: UntypedFormGroup = null;
    let defineControl: UntypedFormControl = null;
   ...
   */
  passwordRegistrationForms(data: UserDataForNew | OperatorDataForNew): UntypedFormGroup[] {
    const passwordControls: UntypedFormGroup[] = [];
