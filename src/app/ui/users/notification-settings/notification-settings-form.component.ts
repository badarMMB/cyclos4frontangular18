  ...
  implements OnInit
{
  ...
  typeControlsMap = new Map<NotificationTypeEnum, UntypedFormControl>();
   ...
   */
  private updateControls(typeForm: UntypedFormGroup) {
   ...
   */
  resolveControl(type: NotificationTypeEnum): UntypedFormGroup {
    const controls = (this.form.controls.notifications as UntypedFormArray).controls;
    for (const control of controls) {
      const typeForm = control as UntypedFormGroup;
