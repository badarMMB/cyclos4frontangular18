...
export class RunWizardComponent extends BasePageComponent<WizardExecutionData> implements OnInit {
  ...
  mobilePhone: UntypedFormGroup;
  landLinePhone: UntypedFormGroup;
  defineAddress: UntypedFormControl;
  address: UntypedFormGroup;
  defineContactInfo: UntypedFormControl;
  contactInfo: UntypedFormGroup;
  customValues: UntypedFormGroup;
  emailValidation: UntypedFormControl;
  smsValidation: UntypedFormControl;
    ...
    if (data.step != null) {
      ...
      switch (step.kind) {
        ...
        case WizardStepKind.FORM_FIELDS:
          ...
          if (data.wizard.kind === WizardKind.REGISTRATION) {
            ...
            if (
              ...
              this.emailValidation = new UntypedFormControl(null);
            ...
            if (data.step.fields?.find(f => f.phoneKind === PhoneKind.MOBILE && f.requireVerification)) {
              this.smsValidation = new UntypedFormControl(null);
        ...
        case WizardStepKind.PHONE_VERIFICATION:
          this.verificationCode = new UntypedFormControl(null, Validators.required);
          break;
      }
    }
  }
